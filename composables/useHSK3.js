    ...
    texts: [
      {
        ...
        lines: [
          ...
          { s: 'B', c: '阴天，电视上说多云。怎么了？有事？',   p: 'Yīntiān, diànshì shàng shuō duōyún. Zěnme le? Yǒu shì?', en: 'Cloudy — the TV said overcast. What’s up? Something going on?' },
          { s: 'A', c: '没事，我们明天要去爬山。',             p: 'Méi shì, wǒmen míngtiān yào qù pá shān.',              en: 'Nothing — we’re going hiking tomorrow.' },
          { s: 'B', c: '爬山的时候要小心点儿。',               p: 'Pá shān de shíhou yào xiǎoxīn diǎnr.',                 en: 'Be careful when you’re hiking.' },
          { s: 'A', c: '好，你也去吗？',                       p: 'Hǎo, nǐ yě qù ma?',                                    en: 'OK — are you coming too?' },
          { s: 'B', c: '我不去，我有事。',                     p: 'Wǒ bú qù, wǒ yǒu shì.',                                en: 'I’m not going — I’m busy.' },
        ],
      },
      {
        title: 'Text 2 · 在商场  At the mall',
        lines: [
          { s: 'A', c: '你觉得这条裤子怎么样？',                       p: 'Nǐ juéde zhè tiáo kùzi zěnmeyàng?',                          en: 'How do you like these pants?' },
          { s: 'B', c: '我记得你已经有两条这样的裤子了。',             p: 'Wǒ jìde nǐ yǐjīng yǒu liǎng tiáo zhèyàng de kùzi le.',       en: 'I remember you already have two pairs of pants like these.' },
          { s: 'A', c: '那我们再看看别的。',                           p: 'Nà wǒmen zài kànkan biéde.',                                 en: 'Then let’s look at something else.' },
          { s: 'B', c: '这件衬衫怎么样？',                             p: 'Zhè jiàn chènshān zěnmeyàng?',                               en: 'How about this shirt?' },
          { s: 'A', c: '还不错，多少钱？',                             p: 'Hái búcuò, duōshao qián?',                                   en: 'Not bad — how much?' },
          { s: 'B', c: '这上面写着三百二十元。',                       p: 'Zhè shàngmian xiězhe sān bǎi èrshí yuán.',                   en: 'It says 320 yuan on the tag.' },
          { s: 'A', c: '买一件。',                                     p: 'Mǎi yí jiàn.',                                               en: 'Buy one.' },
        ],
      },
      {
        title: 'Text 3 · 在水果店  At the fruit shop',
        lines: [
          { s: 'A', c: '这些水果真新鲜，我们买西瓜还是苹果？', p: 'Zhèxiē shuǐguǒ zhēn xīnxiān, wǒmen mǎi xīguā háishi píngguǒ?', en: 'These fruits are really fresh — should we buy watermelon or apples?' },
          { s: 'B', c: '西瓜吧。你看，这上面写着“西瓜不甜不要钱”。', p: 'Xīguā ba. Nǐ kàn, zhè shàngmian xiězhe “xīguā bù tián bú yào qián”.', en: 'Watermelon. Look — the sign says “not sweet, no charge.”' },
          { s: 'A', c: '那我们买一个大点儿的吧。',                 p: 'Nà wǒmen mǎi yí ge dà diǎnr de ba.',                       en: 'Then let’s pick a bigger one.' },
          { s: 'B', c: '再买几个苹果。',                           p: 'Zài mǎi jǐ ge píngguǒ.',                                   en: 'And a few apples too.' },
          { s: 'A', c: '好啊，今天晚上只吃水果不吃饭！',           p: 'Hǎo a, jīntiān wǎnshang zhǐ chī shuǐguǒ bù chī fàn!',      en: 'Great — tonight we’ll only eat fruit, no rice!' },
        ],
      },
      {
        title: 'Text 4 · 在休息室  In the lounge',
        lines: [
          { s: 'A', c: '桌子上放着很多饮料，你喝什么？',     p: 'Zhuōzi shàng fàngzhe hěn duō yǐnliào, nǐ hē shénme?',     en: 'There are lots of drinks on the table — what’ll you have?' },
          { s: 'B', c: '茶或者咖啡都可以。你呢？你喝什么？',   p: 'Chá huòzhě kāfēi dōu kěyǐ. Nǐ ne? Nǐ hē shénme?',         en: 'Tea or coffee — either is fine. And you?' },
          { s: 'A', c: '我喝茶，茶是我的最爱。天冷了或者工作累了的时候，喝杯热茶会很舒服。',
                       p: 'Wǒ hē chá, chá shì wǒ de zuì’ài. Tiān lěng le huòzhě gōngzuò lèi le de shíhou, hē bēi rè chá huì hěn shūfu.',
                       en: 'I’ll have tea — tea is my favourite. When it’s cold or I’m tired from work, a cup of hot tea feels great.' },
          { s: 'B', c: '你喜欢喝什么茶？',                   p: 'Nǐ xǐhuan hē shénme chá?',                                en: 'What kind of tea do you like?' },
          { s: 'A', c: '花茶、绿茶、红茶，我都喜欢。',         p: 'Huāchá, lǜchá, hóngchá, wǒ dōu xǐhuan.',                  en: 'Jasmine, green and black tea — I like them all.' },
        ],
      },
    ],
    vocab: [
    ...
    texts: [
      {
        ...
        lines: [
          { s: 'A', c: '这是你们比赛的照片吗？',                 p: 'Zhè shì nǐmen bǐsài de zhàopiàn ma?',                  en: 'Are these photos from your competition?' },
          { s: 'B', c: '是，这是我们比赛后拍的。',               p: 'Shì, zhè shì wǒmen bǐsài hòu zhào de.',                en: 'Yes — these were taken after the match.' },
          { s: 'A', c: '拍得不错，你们都是一个年级的吗？',       p: 'Zhào de búcuò, nǐmen dōu shì yí ge niánjí de ma?',     en: 'Nicely shot — are you all in the same grade?' },
          { s: 'B', c: '不是。那个又高又漂亮的女孩儿是二年级的。', p: 'Bú shì. Nàge yòu gāo yòu piàoliang de nǚháir shì èr niánjí de.', en: 'No — that tall, pretty girl is in second grade.' },
          { s: 'A', c: '旁边那个拿着书的人是谁？',               p: 'Pángbiān nàge názhe shū de rén shì shéi?',             en: 'Who’s the person beside her holding a book?' },
      ...
      },
      {
        ...
        lines: [
          ...
          { s: 'B', c: '她又聪明又热情，也很努力。',               p: 'Tā yòu cōngming yòu rèqíng, yě hěn nǔlì.',                en: 'She’s clever and warm — and very hard-working.' },
          { s: 'A', c: '我看她总是笑着回答老师的问题。',           p: 'Wǒ kàn tā zǒngshì xiàozhe huídá lǎoshī de wèntí.',        en: 'I’ve noticed she always smiles when answering the teacher.' },
          ...
          { s: 'A', c: '你是不是喜欢她啊？',                       p: 'Nǐ shì bú shì xǐhuan tā a?',                              en: 'Do you maybe like her?' },
          { s: 'B', c: '喜欢她的人太多了，你看那些拿着鲜花站在门口的，都是等她的。', p: 'Xǐhuan tā de rén tài duō le, nǐ kàn nàxiē názhe xiānhuā zhàn zài ménkǒu de, dōu shì děng tā de.', en: 'Lots of people like her — see those holding flowers at the door? They’re all waiting for her.' },
        ],
      },
      {
        title: 'Text 3 · 在超市门口  At the supermarket entrance',
        lines: [
          { s: 'A', c: '我有点儿饿了，我们进超市买点儿东西吧。',         p: 'Wǒ yǒudiǎnr è le, wǒmen jìn chāoshì mǎi diǎnr dōngxi ba.', en: 'I’m a bit hungry — let’s pop in and grab something.' },
          { s: 'B', c: '好啊，这家超市的蛋糕又便宜又好吃，一块儿只要二点九九元。', p: 'Hǎo a, zhè jiā chāoshì de dàngāo yòu piányi yòu hǎochī, yí kuàir zhǐ yào èr diǎn jiǔ jiǔ yuán.', en: 'Sure — the cake here is cheap and tasty, only 2.99 yuan a slice.' },
          { s: 'A', c: '我们买两块儿，回家吃着蛋糕看电视，怎么样？',     p: 'Wǒmen mǎi liǎng kuàir, huí jiā chīzhe dàngāo kàn diànshì, zěnmeyàng?', en: 'Let’s grab two slices, then go home and eat cake while watching TV — sound good?' },
          { s: 'B', c: '好啊，我再去买一些喝的。',                       p: 'Hǎo a, wǒ zài qù mǎi yìxiē hē de.',                       en: 'Great — I’ll grab some drinks too.' },
          { s: 'A', c: '喝着咖啡吃蛋糕，太好了！',                       p: 'Hēzhe kāfēi chī dàngāo, tài hǎo le!',                     en: 'Eating cake while sipping coffee — perfect!' },
        ],
      },
      {
        ...
        lines: [
          ...
          { s: 'B', c: '你们这儿是不是有一个又年轻又漂亮的服务员？', p: 'Nǐmen zhèr shì bú shì yǒu yí ge yòu niánqīng yòu piàoliang de fúwùyuán?', en: 'Do you have a young, pretty server here?' },
          { s: 'A', c: '我们这儿年轻、漂亮的服务员有很多。',     p: 'Wǒmen zhèr niánqīng, piàoliang de fúwùyuán yǒu hěn duō.',  en: 'We have plenty of young, pretty servers here.' },
          { s: 'B', c: '她工作又认真又热情。',                   p: 'Tā gōngzuò yòu rènzhēn yòu rèqíng.',                       en: 'She works conscientiously and warmly.' },
          { s: 'A', c: '您能再说说吗？',                         p: 'Nín néng zài shuōshuo ma?',                                en: 'Could you tell me a bit more?' },
          { s: 'B', c: '她总是笑着跟客人说话。',                 p: 'Tā zǒngshì xiàozhe gēn kèrén shuō huà.',                   en: 'She always smiles when speaking to guests.' },
          { s: 'A', c: '啊，我知道了，你说的是李小美吧？',       p: 'A, wǒ zhīdào le, nǐ shuō de shì Lǐ Xiǎoměi ba?',           en: 'Ah, I see — you’re talking about Li Xiaomei!' },
        ],
      },
    ],
    vocab: [
